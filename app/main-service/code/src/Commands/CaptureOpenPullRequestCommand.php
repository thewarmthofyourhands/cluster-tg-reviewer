...
readonly class CaptureOpenPullRequestCommand
{
    ...
    {
        if ($this->redisLocker->hasLock(ApplicationResourcesEnum::CAPTURE_OPEN_PULL_REQUESTS_PROCESS)) {
            return;
        }

        $this->redisLocker->setLock(ApplicationResourcesEnum::CAPTURE_OPEN_PULL_REQUESTS_PROCESS, 10);
