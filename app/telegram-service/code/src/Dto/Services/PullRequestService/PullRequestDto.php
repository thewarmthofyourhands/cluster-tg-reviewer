...
final readonly class PullRequestDto
{
    public function __construct(
        ...
        private \App\Enums\Services\PullRequestService\PullRequestStatusEnum $status,
    ...
    public function getStatus(): \App\Enums\Services\PullRequestService\PullRequestStatusEnum
    {
        return $this->status;
    }
